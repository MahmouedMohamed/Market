...
<div class=" scrollbar flex overflow-x-auto overflow-y-hidden z-10 md-card-content container text-center">
    <div class="row  align-items-center">
        <div class="col  flex">
            @forelse($promotedProducts as $promotion)
            @if($promotion->product)
            <div class="card m-2 " style="width: 15vw; text-align:center">
